final: main.o menu1.o wav.o processor.o echos.o gainadjustment.o normalization.o
	g++ -std=c++11 -o final main.o menu1.o wav.o processor.o echos.o gainadjustment.o normalization.o

main.o: main.cpp 
	g++ -std=c++11 -c main.cpp

menu1.o: menu1.cpp main.h
	g++ -std=c++11 -c menu1.cpp main.h
